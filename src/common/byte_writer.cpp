...
std::size_t ByteWriter::offset() const noexcept { return offset_; }

std::size_t ByteWriter::remaining() const noexcept { return bytes_.size() - offset_; }

bool ByteWriter::full() const noexcept { return remaining() == 0; }
...
Status ByteWriter::write_unsigned_le(const std::uint64_t value, const std::size_t width,
...
Status ByteWriter::write_u8(const std::uint8_t value) {
  return write_unsigned_le(value, sizeof(value), "write_u8");
}

Status ByteWriter::write_u16_le(const std::uint16_t value) {
  return write_unsigned_le(value, sizeof(value), "write_u16_le");
}

Status ByteWriter::write_u32_le(const std::uint32_t value) {
  return write_unsigned_le(value, sizeof(value), "write_u32_le");
}

Status ByteWriter::write_u64_le(const std::uint64_t value) {
  return write_unsigned_le(value, sizeof(value), "write_u64_le");
}
