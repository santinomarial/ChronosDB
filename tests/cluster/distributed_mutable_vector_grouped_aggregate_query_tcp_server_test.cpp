...
[[nodiscard]] DistributedMutableVectorGroupedAggregateQueryTcpServerConfig
...
TEST(DistributedMutableVectorGroupedAggregateQueryTcpServerTest,
     ServesRealMutableGroupedSufficientStateTcpMutualTlsStream) {
  ...
  auto server = DistributedMutableVectorGroupedAggregateQueryTcpServer::start(
...
TEST(DistributedMutableVectorGroupedAggregateQueryTcpServerTest,
  ...
  EXPECT_EQ(DistributedMutableVectorGroupedAggregateQueryTcpServer::start(std::move(invalid_config))
                .error()
                .code(),
  ...
  auto server = DistributedMutableVectorGroupedAggregateQueryTcpServer::start(std::move(config));
