...
// indices retain caller order and may repeat. Group keys and order keys are canonical and unique.
// Grouped output is keys followed by aggregates; ungrouped output is aggregates only.
