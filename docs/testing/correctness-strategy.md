...
persistence arming, eligible elections, multi-voter leader heartbeats, and node lifecycle. Tests
...
persistence arming, eligible election enumeration with learner/leader exclusion, heartbeat
enumeration with single-voter no-op exclusion, replay-bound truncation, invalid-setup rejection, and
