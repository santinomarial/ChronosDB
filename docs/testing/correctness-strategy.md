...
persistence arming, eligible elections, and node lifecycle. Tests prove complete depth-two delivery/
loss enumeration, complete depth-one delivery/loss/duplication enumeration, complete two-node link
and one-node lifecycle enumeration through depth two, active persistence arming, eligible election
enumeration with learner/leader exclusion, replay-bound truncation, invalid-setup rejection, and
exact retention of duplicate queue exhaustion, terminal-term election exhaustion, and the first
