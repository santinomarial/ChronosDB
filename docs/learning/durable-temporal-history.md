...
one-tablet/no-part Manifest startup paths, crash points, many-tablet skew, mixed-command dispatch,
direct vector differential/lowering, long-history retention models, durable compaction, and
