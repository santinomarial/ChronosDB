...
segment is also terminal and must not trigger fallback or repair. Restore an identity-consistent
root. To serve one durable row-preserving plan, supply the paired
