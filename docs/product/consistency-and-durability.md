...
> **Status: contract specified; single-node WAL coordination, the replicated proof, and its
> Protocol 2.0 negotiation/receipt bytes are implemented.** This document
