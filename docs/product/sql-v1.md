...
> operator and checked left-deep binary plan are implemented; bound multi-source lowering and
> snapshot instantiation remain in progress. A checked adapter now
