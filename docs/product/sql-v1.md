...
> 11 execution concern; Phase 9 has bounded vector/resource substrates and one Boolean filter
> operator, but bound plans cannot yet run through a vectorized product engine. SQL v1 is
