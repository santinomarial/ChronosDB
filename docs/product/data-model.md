...
> **Status: specified, not implemented.** This document defines the planned logical contract. Physical encodings and container choices remain deferred to their roadmap phases and [accepted ADRs](../adr/README.md).
