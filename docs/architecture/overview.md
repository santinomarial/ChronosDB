...
WHERE, ordered projection, fixed-width scalar expressions, and LIMIT into the unary pipeline under
...
[0037](../adr/0037-fixed-width-vector-casts-and-scalar-functions.md). General plan lowering,
variable-width computed output, aggregates, complete part/head visibility, parallel scheduling,
