...
- The feature graph is not completely process-integrated. A three-daemon Linux gate now covers the
  ...
  receiver, bounded stream owners, mutual-TLS sessions, and deadline/admission-bound TCP endpoints
  now cover the first split-leader prerequisites, but finite route acquisition, daemon service, and
