...
- [Distributed row SQL lowering](learning/distributed-row-sql-lowering.md): checked direct-source
  and source-independent output lowering, exact event-time truth, hidden global ordering inputs,
  coordinator projection, LIMIT, and fail-closed row-dependent semantics.
