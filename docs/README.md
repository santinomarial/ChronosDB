...
- [CSEG v2](formats/cseg-v2.md): accepted temporal-history system registry for WAL/Raft source,
  ...
  layout; strict metadata/full-part codecs and bounded complete semantic validation are implemented,
  while projected reading, winner resolution, and Manifest v2 installation remain in progress.
