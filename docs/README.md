...
- [Manifest v2](formats/manifest-v2.md): accepted source-neutral WAL/Raft tablet boundaries, exact
  ...
  implemented together with fail-closed atomic publication of already-durable Manifest v2
  successors; the end-to-end destination ownership coordinator remains in progress.
