...
Compatible multi-tablet vector snapshot ownership, metadata-backed batch construction, worker
execution, result coordination, request partial I/O, authenticated transport, and process
