...
TCP ownership, mid-stream peer-close fault injection, sender/coordinator integration, packaged
multi-tablet grouped execution, multi-process failover, and broad fault/measurement evidence remain
