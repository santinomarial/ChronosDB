...
the next global sequence. Same-table routing, allocation faults, crash injection, many-tablet
skew, and mixed WAL/Raft publication remain in Phase 18 or later format work.
