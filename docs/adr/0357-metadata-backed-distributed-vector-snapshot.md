...
Leader-linearizable and correlated-follower group-keyed proof binding are implemented separately.
Remote proof acquisition, vector worker execution, global coordination, authenticated transport,
