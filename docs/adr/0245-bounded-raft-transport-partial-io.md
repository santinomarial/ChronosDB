...
frames, and configured frame limits. Real TLS descriptors, carrier-wide admission, disconnects,
allocation-failure injection, and hostile long-running partial-I/O schedules remain in the Phase 18
ledger.
