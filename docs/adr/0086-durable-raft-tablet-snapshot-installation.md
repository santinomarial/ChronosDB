...
Raft writes and a successful fifth completion. A separate eight-schedule reopen matrix fails RTAS
cleanup before unlink or after unlink at directory sync, then later fails each Raft repair stage:
