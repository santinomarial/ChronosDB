...
- Plan-bound subscription snapshot execution: service-level allocation sweeps, multi-chunk socket
  backpressure, reactor worker dispatch, and real concurrent publication scheduling. Deterministic
