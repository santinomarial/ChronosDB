...
- Live WAL admission/acknowledgment, mixed `COLUMNAR_APPEND`/temporal recovery dispatch,
  application checkpoints, and CSEG v2 system columns/operation codes for corrections,
