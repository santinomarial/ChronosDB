...
- Live AWS/MinIO/LocalStack validation for the libcurl SigV4 backend; built-in environment/workload/
  instance credential providers, proxy policy, retry jitter/`Retry-After`, parallel multipart parts,
