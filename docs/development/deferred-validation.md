...
- Extend sealed prepared dispatch execution from the synchronous local owner through asynchronous
  admission and authenticated current-leader transport; reconcile duplicate delivery/application;
