...
> **Status: accepted temporal registry and checked layout are implemented; byte codecs, validators,
> readers, writers, and Manifest v2 installation remain pending.**
