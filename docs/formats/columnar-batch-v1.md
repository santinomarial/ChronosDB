...
> **Status: accepted, not implemented.** This is the normative byte specification for immutable
> schema-shaped ingestion batches. It does not change the frozen [WAL v1](wal-v1.md) framing.
